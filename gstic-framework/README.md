...
A structured framework for developing comprehensive business and product strategies, designed to run interactively via [Claude Code](https://docs.anthropic.com/en/docs/claude-code).
